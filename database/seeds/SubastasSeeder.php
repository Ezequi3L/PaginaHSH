...
class SubastasSeeder extends Seeder
{
    ...
    public function run()
    {
    	Subasta::create(['residencia_id' => '20', 'fecha_reserva' => Carbon::now()->addMonths(6), 'monto_minimo' => '3000', 'ganada' => '0']);
    	...
    	Subasta::create(['residencia_id' => '36', 'fecha_reserva' => Carbon::now()->addYears(2), 'monto_minimo' => '6000', 'ganada' => '0']);
